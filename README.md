...
![Ruff status badge](https://github.com/Hochfrequenz/malo-ident-python-models/workflows/Formatting/badge.svg)
...
uv run ruff format src/maloident/v1/_autogenerated.py
```
